 ...
 */
public class MyKeyedBroadcastProcessFunctionExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final DataStream<String> output = srcOne.connect(broadcast).process(
                new KeyedBroadcastProcessFunction<Long, Long, String, String>() {
                    @Override
                    public void processElement(Long value, KeyedBroadcastProcessFunction<Long, Long, String, String>.ReadOnlyContext ctx, Collector<String> out) throws Exception {
                        System.out.println("processElement:" + value);
                    }

                    @Override
                    public void processBroadcastElement(String value, KeyedBroadcastProcessFunction<Long, Long, String, String>.Context ctx, Collector<String> out) throws Exception {
